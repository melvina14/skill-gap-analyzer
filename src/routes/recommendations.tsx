...
import { ArrowRight, BookOpen, Flame, Route as RouteIcon } from "lucide-react";
    ...
    <>
      ...
      <Section className="pt-0">
        <div className="rounded-3xl bg-gradient-hero px-6 py-12 text-center text-primary-foreground sm:px-12">
          ...
          <h2 className="mt-4 text-2xl font-bold">Not sure where to start?</h2>
          <p className="mx-auto mt-2 max-w-xl text-primary-foreground/80">
            Run the skill assessment to get a roadmap tailored to the exact gaps in your profile.
          </p>
          <Link
            to="/assessment"
